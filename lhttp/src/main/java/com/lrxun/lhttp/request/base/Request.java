...
import com.lrxun.lhttp.adapter.AdapterParam;
import com.lrxun.lhttp.adapter.CacheCall;
import com.lrxun.lhttp.adapter.Call;
import com.lrxun.lhttp.adapter.CallAdapter;
...
import com.lrxun.lhttp.convert.Converter;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    protected HttpParams forceQueryParams = new HttpParams();
    ...
    public Request(String url) {
        ...
        //添加强制拼接url的请求参数
        if (go.getCommonQueryParams() != null) {
            queryParams(go.getCommonQueryParams());
        }
    ...
    @SuppressWarnings("unchecked")
    public R queryParams(HttpParams forceQueryParams) {
        this.forceQueryParams.put(forceQueryParams);
        return (R) this;
    }
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) {
            client = LHttp.getInstance().getOkHttpClient();
        }
